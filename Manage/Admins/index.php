...
<head>
  ...
  <ul style="list-style: none; margin: 0; display: flex; align-items: center;">
    ...
    <li style="margin-right: 100px;"><a href="index.php" style="color: white; text-decoration: none; font-size: 25px; font-family: Arial, sans-serif;">Admins</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control" name="id" placeholder="Enter Admin ID">
		  </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit an Admin's Data</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="container">
	<div class="jumbotron bg-white">
		<div class="card">
		<h2 style="font-size:5vw"> Admin Management </h2>
		<h3 style="font-size:1vw"> Add the Admin for the Website</h3>
		</div>
		<div class="card">
			<div class ="card-body">
