  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
			<label>Surname</label>
			<input type="text" class="form-control" name="surname" placeholder="Enter the Surname">
		  </div>
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control" name="studentno" placeholder="Enter the Student Number">
		  </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit a User's information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<!-- ########################################################################################### -->
	...
	<div class="jumbotron bg-white">
		<div class="card">
		<h2 style="font-size:5vw"> User Management </h2>
		<h3 style="font-size:1vw"> Add the Users for the Website</h3>
		</div>
		<div class="card">
			<div class ="card-body">
