...
<head>
  ...
  <ul style="list-style: none; margin: 0; display: flex; align-items: center;">
    ...
    <li style="margin-right: 100px;"><a href="../Manage/Messages/index.php" style="color: white; text-decoration: none; font-size: 25px; font-family: Arial, sans-serif;">Messages</a></li>
    <li><a href="BookRequests.php" style="color: white; text-decoration: none; font-size: 25px; font-family: Arial, sans-serif;">Requests</a></li>
  </ul>
</nav>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		   ...
		   <form action="insertbookcode.php" method="POST">
...
<div class="container">
	<div class="jumbotron bg-white">
		<div class="card">
		<h2 style="font-size:5vw"> Book Requests </h2>
			...
			<table class="table">
				  ...
				  <tbody>
					<tr>
						  ...
						  <form action="deletebookrequestcode.php" method ="post">
